...
const RideCard=({
    ...
    <View className="flex flex-row items-center  justify-center bg-white
     ...
     <View className="flex flex-row  items-center gap-x-2">
           ...
           <Text className="text-md font-Jakartamedium numberofLines={1}">{destination_address}
           </Text>
          </View>
          </View>
          </View>

<View className ="flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 item-start
justify-center">
