...
const RideCard = ({
  ...
  const mapUri = (destination_longitude && destination_latitude)
      ...
      <View className="flex flex-col items-center justify-center p-3">
        <View className="flex flex-row items-center justify-between">
          {mapUri ? (
            ...
            <View className="w-[80px] h-[90px] bg-gray-200 rounded-lg items-center justify-center">
              <Image source={icons.map} className="w-6 h-6 opacity-30" />
            </View>
          )}
