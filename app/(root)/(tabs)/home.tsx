...
export default function Page() {
  const { userLocation, setUserLocation, setDestinationLocation } = useLocationStore();
  const { user } = useUser();
        ...
        ListHeaderComponent={
          <>
            ...
            <GoogleTextInput
              ...
              initialLocation={userLocation?.address ?? "Where do you want to go?"}
            />
